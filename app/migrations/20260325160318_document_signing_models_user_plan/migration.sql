...
-- CreateEnum
CREATE TYPE "SignatureFieldType" AS ENUM ('SIGNATURE', 'INITIALS', 'DATE');
...
-- AddForeignKey
ALTER TABLE "SignatureImage" ADD CONSTRAINT "SignatureImage_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
