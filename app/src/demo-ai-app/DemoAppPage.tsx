      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-muted-foreground mt-3 text-lg">
            Documents and your AI day scheduler
          </p>
        </div>

        <div className="mx-auto my-10 w-full max-w-5xl space-y-8 px-4">
        ...
        <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-center text-lg leading-8">
          This example uses OpenAI chat completions with function calling to
          build a structured schedule from your tasks.
        </p>
